...
scala> JwtHeader()
res0: pdi.jwt.JwtHeader = JwtHeader(None,None,None,None)

scala> JwtHeader(JwtAlgorithm.HS256)
res1: pdi.jwt.JwtHeader = JwtHeader(Some(HS256),Some(JWT),None,None)

scala> JwtHeader(JwtAlgorithm.HS256, "JWT")
res2: pdi.jwt.JwtHeader = JwtHeader(Some(HS256),Some(JWT),None,None)
...
res6: pdi.jwt.JwtHeader = JwtHeader(Some(HS256),Some(JWT),None,None)
```
