...
res6: String = eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzUxMiJ9.eyJleHAiOjE0Nzg3ODkyMDQsImlhdCI6MTQ3ODc4OTE5NCwidXNlciI6MX0.wypPieFKuDmnzaHvYyxkV2OzBaSsfLLCzdzoJmENPSUcW0tY-8cVoLmubrcGT6SMt83SFyOW01MJYgCYHqqZ-w
...
res33: scala.util.Try[String] = Failure(pdi.jwt.exceptions.JwtNotBeforeException: The token will only be valid after 2016-11-10T14:46:40Z)
```
...
pdi.jwt.exceptions.JwtNotBeforeException: The token will only be valid after 2016-11-10T14:46:41Z
...
expiredToken: String = eyJhbGciOiJub25lIn0.eyJpc3MiOiJtZSIsImV4cCI6MTQ3ODc4OTE5Nn0.
...
res54: scala.util.Try[String] = Failure(pdi.jwt.exceptions.JwtExpirationException: The token is expired since 2016-11-10T14:46:36Z)
...
res57: scala.util.Try[String] = Success({"iss":"me","exp":1478789196})
```
...
res60: scala.util.Try[String] = Success({"iss":"me","exp":1478789196})
```
